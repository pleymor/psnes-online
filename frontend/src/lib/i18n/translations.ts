export const translations = {
  en: {
    ...
    vrKeepRom: 'Keep it on this device?',
    vrKeepRomLegal: 'Only keep a game if you own the original cartridge.',
  ...
  fr: {
    ...
    vrKeepRom: 'Le garder sur cet appareil ?',
    vrKeepRomLegal: 'Ne garde un jeu que si tu possèdes la cartouche originale.',
