export const translations = {
  en: {
    ...
    romHas: 'Has the ROM',
    romMissing: 'Does not have the ROM',
    romUnknown: 'No way to tell',
    romUnknownHint: 'This game has no recorded checksum, so there is nothing to compare.',
  ...
  fr: {
    ...
    romHas: 'A la ROM',
    romMissing: 'N’a pas la ROM',
    romUnknown: 'Impossible de savoir',
    romUnknownHint: 'Ce jeu n’a pas de somme de contrôle enregistrée, il n’y a rien à comparer.',
