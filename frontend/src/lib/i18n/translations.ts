export const translations = {
  en: {
    ...
    keepRom: 'Keep it on this device?',
  ...
  fr: {
    ...
    keepRom: 'Le garder sur cet appareil ?',
    keepRomLegal: 'Ne garde un jeu que si tu possèdes la cartouche originale.',
