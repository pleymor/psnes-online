export const translations = {
  en: {
    ...
    localSavesInFolder: 'saves are written next to each ROM in your folder (.srm, .state1…).',
    ...
    localSaves: 'Saves',
    localSlot: 'Slot {n}',
    localSlotEmpty: 'empty',
    localSaveHere: 'Save',
    localLoadHere: 'Load',
    localSaved: 'Saved in slot {n}',
    localLoaded: 'Slot {n} loaded',
    localSaveFailed: 'The save could not be written',
  ...
  fr: {
    ...
    localSavesInFolder: 'les sauvegardes sont écrites à côté de chaque ROM, dans ton dossier (.srm, .state1…).',
    ...
    localSaves: 'Sauvegardes',
    localSlot: 'Emplacement {n}',
    localSlotEmpty: 'vide',
    localSaveHere: 'Sauvegarder',
    localLoadHere: 'Charger',
    localSaved: 'Sauvegardé dans l’emplacement {n}',
    localLoaded: 'Emplacement {n} chargé',
    localSaveFailed: 'La sauvegarde n’a pas pu être écrite',
